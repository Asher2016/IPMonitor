...
(function ($) {
    ...
    $.jqPagination = function (el, options) {
        ...
        base.resetPagination = function (current_page, max_page) {
            base.options.current_page = parseInt(current_page, 10);
            base.options.max_page = parseInt(max_page, 10);
            base.setInputValue(current_page);
            base.setLinks(current_page);
            base.options.paged(base.options.current_page);
        }
    ...
    $.fn.jqPagination = function () {
        ...
        self.each(function () {
            (jqPagination = new $.jqPagination(this, args[0]));
        });
